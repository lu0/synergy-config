...
QT_INIT_METAOBJECT const QMetaObject ScreenSettingsDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_ScreenSettingsDialog.data,
    qt_meta_data_ScreenSettingsDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
