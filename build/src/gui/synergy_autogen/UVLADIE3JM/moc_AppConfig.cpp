...
void AppConfig::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AppConfig::zeroConfToggled)) {
                *result = 1;
                return;
            }
        }
...
void *AppConfig::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "GUI::Config::ConfigBase"))
        return static_cast< GUI::Config::ConfigBase*>(this);
...
// SIGNAL 1
void AppConfig::zeroConfToggled()
{
