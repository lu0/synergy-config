...
void ActivationNotifier::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ActivationNotifier *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (ActivationNotifier::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ActivationNotifier::finished)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ActivationNotifier::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_ActivationNotifier.data,
    qt_meta_data_ActivationNotifier,
    qt_static_metacall,
    nullptr,
    nullptr
} };
