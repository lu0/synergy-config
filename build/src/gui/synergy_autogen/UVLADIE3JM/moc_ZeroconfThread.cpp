...
void ZeroconfThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ZeroconfThread::*)(QTcpSocket::SocketError );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ZeroconfThread::error)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ZeroconfThread::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_ZeroconfThread.data,
    qt_meta_data_ZeroconfThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
